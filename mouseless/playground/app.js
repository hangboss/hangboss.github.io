const longStr = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima corporis neque porro explicabo odio, exercitationem consectetur veritatis in vel accusantium reiciendis hic, molestias quasi placeat ratione et sunt animi dolorem.';
const app = Vue.createApp({
    ...
    methods: {
        ...
        setupPracticeArea() {
                ...
                const scrollHtml = `
                    <div style="height: 400px;" class="w-full overflow-auto border-2 border-dashed border-gray-300 rounded-xl">
                        <div class="p-4" style="min-width:200%; min-height:1000px">
                            ...
                            ${Array(10).fill(`<div class="my-4 p-4 bg-gray-200 rounded">${longStr}</div>`).join('')}
                        </div>
                    </div>
                `;
            ...
            // If this is the area positioning step, generate target elements at specific positions
                ...
                setTimeout(() => {
                    ...
                    const existingTargets = practiceArea.querySelectorAll('.target-element');
            ...
            for (let i = 0; i < targetCount; i++) {
                ...
                if (fixedPosition) {
                    ...
                    do {
                        ...
                        isValidPosition = this.checkTargetPosition(xPercent, yPercent, size, targetPositions, minDistance, containerWidth, containerHeight);
                        attempts++;
                    ...
                    if (!isValidPosition && attempts >= maxAttempts) {
                        ...
                        isValidPosition = this.checkTargetPosition(xPercent, yPercent, size, targetPositions, reducedDistance, containerWidth, containerHeight);
                    }
                }
                ...
                // Add animation
                setTimeout(() => {
                    targetElement.style.transition = 'all 0.3s cubic-bezier(0.18, 0.89, 0.32, 1.28)';
        ...
        checkTargetPosition(xPercent, yPercent, size, existingPositions, minDistance, containerWidth, containerHeight) {
            ...
            for (const pos of existingPositions) {
                ...
                const minDistancePx = (minDistance / 100) * Math.min(containerWidth, containerHeight);
